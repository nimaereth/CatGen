...
# Add in platforms
platforms = {}
for biome in ['beach', 'forest', 'mountainous', 'plains']:
    for season in ['greenleaf_dark', 'greenleaf_light', 'leafbare_dark', 'leafbare_light', 'leaffall_dark',
                   'leaffall_light', 'newleaf_dark', 'newleaf_light']:
        platforms[biome + season] = pygame.image.load('resources/images/platforms/' + biome + '/' + season +
                                                      '.png').convert_alpha()